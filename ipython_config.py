...
# c.InteractiveShell.banner1 = 'Python 3.4.3 |Anaconda 2.3.0 (64-bit)| (default, Jun  4 2015, 15:29:08) \nType "copyright", "credits" or "license" for more information.\n\nIPython 4.0.0 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
...
#------------------------------------------------------------------------------
# Useful recipes to make use of the debugger
#------------------------------------------------------------------------------

# The set_trace function stops the code so you can take a look around (for 
# example, right before an exception occurs).
def set_trace():
    from IPython.core.debugger import Pdb
    Pdb(color_scheme='Linux').set_trace(sys._get_frame().f_back)

# The debug function enables you to invoke the interactive debugger easily on an 
